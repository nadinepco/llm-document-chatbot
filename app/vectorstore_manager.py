...
class VectorStoreManager:
    ...
    def _load_and_chunk_docs(self, pdf_docs) -> list:
        """
        Load PDF files as tempfile, split documents into chunks, and return a list of document chunks.
        """
        documents = []
    ...
    def create_vectorstore(self, pdf_docs):
        ...
        doc_chunks = self._load_and_chunk_docs(pdf_docs)
